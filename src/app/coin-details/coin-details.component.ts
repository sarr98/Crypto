...
export class CoinDetailsComponent implements OnInit {
  ...
  constructor(private api:ApiService, private activeRoute: ActivatedRoute, private currencyService:CurrencyService) { }

  ngOnInit(): void {
    this.activeRoute.params.subscribe(value => {
      this.coinId=value['id'];
      this.getCoinData();
      this.getGraphicData(this.days);
      this.currencyService.getCurrency().subscribe(val => {this.currency=val; this.getGraphicData(this.days);this.getCoinData()});
    })
  }
  getCoinData(){
